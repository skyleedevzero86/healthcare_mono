package com.sleekydz86.service.healthcare.common;
...
public class MetricsCollector {
    ...
    public Map<String, Object> collectCustomMetrics() {
        ...
        addMetric(metrics, "cacheHitRate", "cache.hit.rate", MetricType.GAUGE);
        addMetric(metrics, "databaseConnections", "database.connections.active", MetricType.GAUGE);
