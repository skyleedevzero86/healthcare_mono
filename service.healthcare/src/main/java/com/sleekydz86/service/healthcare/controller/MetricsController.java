...
public class MetricsController {
    ...
    public ResponseEntity<Map<String, Object>> customMetrics() {
        ...
        try {
            double dbConnections = meterRegistry.get("database.connections.active").gauge().value();
            metrics.put("databaseConnections", dbConnections);
        } catch (Exception e) {
            metrics.put("databaseConnections", 0.0);
        }
