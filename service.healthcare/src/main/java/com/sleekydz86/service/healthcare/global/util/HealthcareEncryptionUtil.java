...
public class HealthcareEncryptionUtil {
    ...
    private static String getKeyByType(KeyType keyType) {
        switch (keyType) {
            case AUTH: return AUTH_KEY != null ? AUTH_KEY : "default_auth_key_32_chars_long_2025";
            case USER: return USER_KEY != null ? USER_KEY : "default_user_key_32_chars_long_2025";
            case HEALTH: return HEALTH_KEY != null ? HEALTH_KEY : "default_health_key_32_chars_long_2025";
            default: return "default_encryption_key_32_chars_long_2025";
        }
    }
