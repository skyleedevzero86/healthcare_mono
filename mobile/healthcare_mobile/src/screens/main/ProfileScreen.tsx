...
import { sendNotification, checkPermissions } from '../../store/slices/permissionSlice';
  ...
  const handleTestNotification = async () => {
    try {
      await dispatch(sendNotification({
        title: '헬스케어 알림',
        body: `${user?.userNm || '사용자'}님, 건강 상태를 확인해보세요!`,
      })).unwrap();
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container}>
        ...
        <View style={styles.actionSection}>
          ...
          >
            <Text style={styles.actionButtonText}>테스트 알림</Text>
          </TouchableOpacity>
