...
import { getCurrentLocation } from '../../store/slices/permissionSlice';
  ...
  const handleGetLocation = async () => {
    try {
      ...
      if (location) {
        ...
        Alert.alert('위치 정보', `현재 위치: ${currentLocation}`);
      }
    } catch (error) {
      Alert.alert('위치 정보 가져오기 실패', error as string);
    }
  };
        ...
        {showWriteForm && (
          <View style={styles.writeForm}>
            ...
            <View style={styles.locationSection}>
              <Text style={styles.locationSectionTitle}>위치 정보</Text>
              <TouchableOpacity style={styles.locationButton} onPress={handleGetLocation}>
                <Text style={styles.locationButtonText}>현재 위치 가져오기</Text>
              </TouchableOpacity>
              {currentLocation && (
                <View style={styles.locationInfo}>
                  <Text style={styles.locationText}>위치: {currentLocation}</Text>
                </View>
              )}
            </View>
