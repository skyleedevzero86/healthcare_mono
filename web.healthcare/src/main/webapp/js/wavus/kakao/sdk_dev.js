window.kakao = window.kakao || {}, window.kakao.maps = window.kakao.maps || {}, window.daum && window.daum.maps ? window.kakao.maps = window.daum.maps : (window.daum = window.daum || {}, window.daum.maps = window.kakao.maps),
    function() {
        ...
        o.VERSION = {
            ...
            BICYCLE: "6.00",
            USE_DISTRICT: "2012tlq",
            SKYVIEW_VERSION: "160114",
            SKYVIEW_HD_VERSION: "160107"
        }, o.RESOURCE_PATH = {
//            ROADVIEW_AJAX: "//t1.daumcdn.net/roadviewjscore/core/css3d/200204/standard/1580795088957/roadview.js",		// 운영 경우
//            ROADVIEW_CSS: "//t1.daumcdn.net/roadviewjscore/core/openapi/standard/210215/roadview.js"								// 운영 경우
//        		ROADVIEW_AJAX: "//rdims.lh.or.kr/js/wavus/kakao/roadview.js",																		// 운영 경우(인터넷 막힐시)
//        		ROADVIEW_CSS: "//rdims.lh.or.kr/js/wavus/kakao/roadview_css.js"																	// 운영 경우(인터넷 막힐시)
    		ROADVIEW_AJAX: "//localhost:10001/js/wavus/kakao/roadview.js",																		// DEV 경우
        	ROADVIEW_CSS: "//localhost:10001/js/wavus/kakao/roadview_css.js"																	// DEV 경우
        };
        ...
        var c = o.onloadcallbacks,
            ...
            S = "",
            I = {
//                v3: r + "//t1.daumcdn.net/mapjsapi/js/main/4.3.2/kakao.js",								// 운영 경우
//                v3: r + "//rdims.lh.or.kr/js/wavus/kakao/kakao.js",											// 운영 경우(인터넷 막힐시)
                v3: r + "//localhost:10001/js/wavus/kakao/kakao_dev.js"										// DEV 경우
