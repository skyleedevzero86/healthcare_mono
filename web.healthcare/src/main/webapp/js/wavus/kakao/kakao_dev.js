(function (Q) {
    ...
    function bc(a, b, d) {
        for (var F in a)
            a.hasOwnProperty(F) && b.call(d, F, a[F])
    }
    function Pa(a, b) {
        return a.indexOf(b)
    }
    ...
    function L(a, b, d) {
        ya(a, "width:" + (Da(b) ? y(0, b) + "px" : b) + ";height:" + (Da(d) ? y(0, d) + "px" : d))
    }
    function za(a, b, d, F, c) {
        d === C && (d = b);
        F === C && (F = b);
        c === C && (c = d);
        b = String((Da(b) ? b + "px" : b) + " " + (Da(d) ? d + "px" : d) + " " + (Da(F) ? F + "px" :
                    F) + " " + (Da(c) ? c + "px" : c));
        a.style.margin = b
    }
    function qa(a, b) {
    ...
    function ra(a, b) {
        ...
        var c = d = 0;
        do
            d += b.offsetLeft || 0, c += b.offsetTop || 0;
    ...
    function Xa(a) {
        Ka.call(this, a);
        for (var b = 0, a = ["webkit", "moz"], d = Wa.requestAnimationFrame, c = Wa.cancelAnimationFrame, e = 0; e < a.length && !d; ++e)
            d = Wa[a[e] + "RequestAnimationFrame"], c = Wa[a[e] + "CancelAnimationFrame"] || Wa[a[e] + "CancelRequestAnimationFrame"];
        d || (d = function (a) {
            var d = +new Date,
            c = y(0, 16 - (d - b)),
                ...
                if ("path" === a.type) {
                    ...
                    m(d, function (d) {
                        e.moveTo(d[0] ||
                            0, d[1] || 0);
                        if (d[0] == d[2] && d[1] == d[3])
                            e.arc(d[0], d[1], a.Zc / 4, 2 * Math.PI, l);
                        else
    ...
    function Ld(a, b, d, c) {
        ...
        if (e)
            return e.setAttribute("style", "stroke:none;fill:" + c), b;
        e = gc("marker");
        e.id = b;
    ...
    function hc(a, b) {
        var d = b.a;
        b instanceof tb ? (a.Dk = b, a.overlayLayer = a.Ue = d) : b instanceof ic && (a.yk = b, a.graphicsLayer = a.xk = d)
    }
    function Lb(a) {
        this.b = a
    }
    ...
    function Fc(a, b) {
        a.Hb != b && (a.Hb = b, qa(a.a, b ? "default" : "pointer"), pb(b && a.Xh || a.ic, a.a))
    }
    function ic() {
        this.o = {};
        this.Rf = this.Qf = 0
    ...
    function wa(a) {
        return Ba + (Ia ? "ssl.daumcdn.net/" : "") + "map" + a + ".daumcdn.net"
    }
    function nc() {
        return Ba + "boundary.map.daum.net"
    }
    function Ob(a) {
    ...
    function Wd() {
        ...
        wb("BICYCLE_HD", be);
        wb("BICYCLE_HYBRID_HD", ce);
        Ca[ka.USE_DISTRICT] = de;
        wb("USE_DISTRICT_HD", ee);
        Pb = j
    }
    function Hc() {
        ub.call(this)
    ...
    function je(a) {
        if (a.T.ae) {
            ...
            a.fa && (a.fa.title = a.Fb)
    }
    function le(a) {
        var b = a.T.ae ? a.Dc : a.fa,
        d = M ? "touchstart" : ta ? "MSPointerDown" : "mousedown";
        a.Lh = k(b, M ? "touchend" : ta ? "MSPointerUp" : "click", a.gd, a);
        a.ki = k(b, d, a.hi, a);
        M || (a.Ri = k(b, "mouseover", a.Kc, a), a.Qi = k(b, "mouseout", a.Jc, a), a.uj = zb || me ? k(a.a, "contextmenu", a.li, a) : k(b, "contextmenu", a.Wd,
                    a))
    }
    function ne(a) {
        a.yd = j;
    ...
    function jd(a, b) {
        var d = [k(b, M ? "touchstart" : "mousedown", a.di, a), k(b, M ? "touchmove" : "mousemove", a.Re, a), k(b, M ? "touchend" : "mouseup", a.Wj, a)];
    ...
    function te(a, b) {
        a.bc = b;
        for (var d = a.Sf, c; c = d.firstChild; )
            d.removeChild(c);
...
//        	Va(a, "url(" + Bb + "bg_tile.png)")
        
        	// 프록시
//        	Va(a, "url(/biz/si/main/getMapImg.do?url=" + Bb + "bg_tile.png)") // 기존
        	Va(a, "url(/biz/si/main/getImgProxy.do?url=" + Bb + "bg_tile.png)") // 프록시 사용
    }
    function Mc(a, b) {
        this.ja(a, b)
    }
    ...
    function md(a,
        ...
        this.Hd = this.ra = this.Je = this.Le = this.Ke = 0;
        this.hb = new Xa;
    ...
    function rc(a) {
        ...
        a = f;
        document.createElementNS && document.implementation && document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? a = new sb : Q.HTMLCanvasElement ? a = new Yc : document.namespaces && document.namespaces.add && (document.namespaces.add("v",
        ...
        this.t.addListener("panned", this.Ve, this);
        ...
        M ? (this.Hk = k(a, "touchstart", this.Tj, this), this.Ei = k(a, "touchmove", this.tg, this), this.Fi = k(a, "touchend", this.ug, this)) : (this.Ck = k(a, "mousedown", this.Ne, this), this.Ei = k(a, "mousemove", this.tg, this), this.Fi = k(a, "mouseup", this.ug, this));
    ...
    function xe(a, b) {
        var d = a.ta.a;
        b && !a.H ? (d.style.Rj = "none", a.oc(f), a.ta.oc(l), a.H = l) : !b && a.H && (d.style.Rj =
                "auto", a.ga !== f && a.ub(f, l), a.oc("default"), a.ta.oc(j), a.H = j)
    }
    function ye(a, b) {
        if (b && !a.af) {
            var d = a.ta.a;
            a.Pi = k(d, "mousewheel", a.Qe, a);
            a.Oi = k(d, "DOMMouseScroll", a.Qe, a);
            a.ak = k(d, "wheel", a.Qe, a);
            a.af = l
        } else !b && a.af && (x(a.Pi), x(a.Oi), x(a.ak), a.af = j)
    }
    function ze(a, b) {
        if (b && !a.we) {
            var d = a.ta.a;
            a.si = k(d, Na ? "touchstart" : "gesturestart", a.gg, a);
            ta && (a.Se = new Q.MSGesture, a.Se.target = a.t.a, a.Oc = 0, a.Wi = k(d, "MSPointerDown", a.gg, a), a.Vi = k(d, "selectstart", ba, a));
            a.we = l
        } else !b && a.we && (x(a.si), ta && (x(a.Wi), x(a.Vi),
                    a.Se = f, a.Oc = 0), a.we = j)
    }
    function Ja(a) {
        var b = a.u.sb(),
        d = a.b.j(),
    ...
    function Ae(a, b) {
        ...
        e = S(a.Ed, d.Q);
        c.Q = e;
        c.j() < d.B && (qc(c, d.B, c.I()), m(a.sa, Nc), a.J.q(), a.ia.q());
        c.j() > d.Q && (qc(c, d.Q, c.I()), m(a.sa, Nc), a.J.q(), a.ia.q());
        Be(a);
        a.u.Wc(d);
        a.u.q();
        b != ka.HYBRID ? a.wd &&
        (a.Ze(ka.OVERLAY), a.wd = j) : a.wa != ka.HYBRID && !a.wd && (a.ke(ka.OVERLAY, l), a.wd = l);
        Ja(a);
        c = a.Oa;
        d = d.Sh;
        o(c.a, {
    ...
    function De(a, b) {
        if (!a.G && (Db(a), Kc(a.ta, l), a.ga === f)) {
            ...
            M ? (a.uh = k(d, "touchmove", a.Sj, a, {
                    passive: j
                }), a.sh = k(d, "touchend", a.th, a), a.rh = k(d, "touchcancel", a.th, a)) : ta ? (a.Oe = k(d, "MSPointerMove", a.Gd, a), a.Pe = k(d, "MSPointerUp", a.ub, a)) : (a.Oe =
                    k(d, "mousemove", a.Gd, a), a.Pe = k(d, "mouseup", a.ub, a));
            a.ga = l;
    ...
    function sc(a, b, d, c) {
        ...
        if (n < e.B || n > e.Q)
            ...
            n = c.Yb;
            a.le = c.complete || R;
            c.Jh ? (c = ha(e), Y = ia(e), e = bd(e.I(), e), a.Me(b, E, d, c, Y, c + (e.e() - E), Y + (e.c() - d), g, n)) : a.Yd(b, E, d, g, n)
        }
    }
    function Be(a) {
        Gc(a.na.a, 1);
    ...
    function He(a) {
        a.ye != f && (Na && (x(a.xe), a.xe = f), x(a.ye), x(a.fg), a.ye = f, a.fg = f)
    }
    function Eb(a) {
        i(a, "idle")
    }
    ...
    function Ie(a, b, d) {
        ...
        if (g == e)
            ...
            c = c.$b,
            f = Math.pow(2, g - e),
            n = a.g.ab(a.g.ne((f * n.e() - c.e()) / (f - 1), (f * n.c() - c.c()) / (f - 1)));
    ...
    function T(a, b) {
        ...
        o(g, {
            ...
            padding: "10px",
            margin: "-100% 2% 5px",
            "background-image": 'url("' + Ba + 't1.daumcdn.net/mapjsapi/images/bg_1x1_white_80.png")',
    ...
    function Pc(a) {
        var b,
        a = a || {};
        b = tc && !Ia ? "//spi.maps.daum.net/rv/" : Ba + (Ia ? "ssl.daumcdn.net/" : "") + "rv.maps.daum.net/";
    ...
    lb = db && !Q.HTMLCanvasElement,
    zb = -1 == navigator.appVersion.indexOf("MSIE 7.") ? j : l,
    me = 7 === document.documentMode ? l : j,
    Hb = lb && !Q.XMLHttpRequest;
    if (Hb)
        try {
    ...
    Ba = tc ? "https://" : "http://",
    mb = Ba + (Ia ? "ssl.daumcdn.net/" : "i1.daumcdn.net/") + "dmaps/apis/",
    bf = Ba + (Ia ? "ssl.daumcdn.net/" : "s1.daumcdn.net/") + "dmaps/apis/",
    vc = Ba + (Ia ? "ssl.daumcdn.net/" : "") + "t1.daumcdn.net/localimg/localimages/07/mapjsapi/",
    Bb = Ba + (Ia ? "ssl.daumcdn.net/" : "") + "t1.daumcdn.net/mapjsapi/images/",
    Pe = Ba + (Ia ? "ssl.daumcdn.net/" : "") + "dmaps.daum.net/apis/";
    Pb && (vc += "2x/", Bb += "2x/");
    tc && !Ia && (Pe = "//spi.maps.daum.net/imap/apis/");
    
//    var Tb = mb + "transparent.gif", // 기존
    mb =  "i1.daumcdn.net/dmaps/apis/"; // 프록시
    var Tb = "/biz/si/main/getMapProxyImg.do?url=" +mb + "transparent.gif", // 프록시
    ...
    $e = ["-webkit-", "-moz-", "-ms-", "-o-", ""],
    df = db || Qe ? "url(" + mb + "cursor/openhand.cur.ico), default" : "url(" + mb + "cursor/openhand.cur.ico) 7 5, url(" + mb + "cursor/openhand.cur.ico), default",
    he = db || Qe ? "url(" + mb + "cursor/closedhand.cur.ico), move" : "url(" + mb + "cursor/closedhand.cur.ico) 7 5, url(" + mb + "cursor/closedhand.cur.ico), move",
    Re = Hb ? function (a, b) {
    ...
    c.Ba = function (a) {
        this.of = this.of || a;
        this.xg > a - this.of || (this.of = 0, this.de = this.de || a, a = S(1, (a - this.de) / this.dc) || 0, a = this.pf(a), this.Mi(a), 1 <= a && (i(this, "done"), this.X()))
    };
    c.reset = function () {
        this.de = f
    };
    ...
    Wc.prototype.q = function (a) {
        i(this, "tick", {
            ...
            vb: this.Pa,
            wb: this.Qa,
            ge: this.ee * (1 - a) + this.qe * a,
            he: this.fe * (1 - a) + this.se * a
        })
    };
    q(Xc, La);
    Xc.prototype.q = function (a) {
        i(this, "tick", {
            Wg: a,
            ge: this.ee + (this.qe - this.ee) * a,
            he: this.fe + (this.se - this.fe) * a
        })
    };
    q(ec, La);
    ...
    sb.prototype.yc = function (a, b, d, c, e) {
        var g = "";
        m(b, function (a) {
            zc(a) &&
            (a = a.match(/\d+/g));
        ...
        if (db) {
            ...
            m(["start", "end"], function (a) {
                if (a = document.getElementById(this.Td + "-arrow-" + a + "-" + n))
                    this.nd.removeChild(a), this.nd.appendChild(a)
            }, this)
        }
    };
    sb.prototype.pd = function (a, b, d, c, e) {
        Jb(a, {
            cx: b,
            cy: d,
            rx: c,
    ...
    sb.prototype.vc = function (a, b, d) {
        var a = a.id,
        c = 0 > Pa(this.ob[d] || [], a);
        if (0 !== b - d || c)
            c ? (this.ob[b] =
    ...
    Ya.prototype.lb = function (a, b, d) {
        ...
        if (!e || !e.getPointFromPanTilt)
            return new z(-1E4, -1E4);
        if (a instanceof Z)
            d = v(a.pan, Number(e.getPan()) || 0), g = v(a.tilt, Number(e.getTilt()) || 0);
        else {
            n = c.v();
            c = a.e() - n.e();
            n = a.c() - n.c();
    ...
    c.fj = function (a) {
        ...
        a.addListener("done", this.Ve, this);
    ...
    c.M = function () {
        ...
        ad(this, j);
        this.Ge && (k(this.a, "mouseover", this.Kc, this), k(this.a, "mouseout", this.Jc, this));
        k(this.a, "mousedown", this.Ne, this);
        k(document, "mouseup", this.ub, this);
        k(this.a, "click", this.gd, this)
    };
    c.mc = j;
    c.Kc = function () {
        !this.mc && !this.Hb && pb(this.Ge, this.a)
    };
    c.Jc = function () {
        !this.mc && !this.Hb && pb(this.ic, this.a)
    };
    c.Ne = function (a) {
        ba(a);
        Gd(a) && !this.mc && !this.Hb && pb(this.ci || this.ic,
            this.a)
    };
    c.ub = function () {
        !this.mc && !this.Hb && pb(this.ic, this.a)
    ...
    c.gd = function () {
        !this.mc && !this.Hb && (pb(this.Ge || this.ic, this.a), i(this, "click"))
    };
    var qb = 116,
    rb = 264,
    dc = Bb + "control.png";
    ...
    Nb.prototype.ie = function (a, b) {
        a.parentNode != this.a && (Da(b) ?
    ...
    ib.prototype.C = function (a) {
        this.f != a && (a ? (this.f = a, this.a || (this.a = p("div"), L(this.a, 106, 32), o(this.a, {
                    ...
                    this.Kd = new Mb(43, 32, pf, f, f, f, qf, "\uc9c0\ub3c4"), this.ce = new Mb(63, 32, rf, f, f, f, sf, "\uc2a4\uce74\uc774\ubdf0"), ca(this, this.Kd), ca(this, this.ce), this.Kd.addListener("click", this.Yi, this), this.ce.addListener("click", this.Gj, this)), this.L(), this.f.addListener("maptypeid_changed", this.L, this)) : (this.f.removeListener("maptypeid_changed", this.L, this), this.f = a))
    };
        ...
        if (this.f != a)
            if (a) {
                ...
                if (!this.a) {
                    ...
                    c = p("div");
                    eb(c);
                    Va(c, "url(" + Ba + "t1.daumcdn.net/mapjsapi/images/bg_zoom_control.png) repeat");
                    o(c, {
                        padding: "7px 0",
                    ...
                    hb(c, qb, rb);
                    b.appendChild(c);
                    this.Te || (this.qf = [k(d, "mouseover", this.fh, this), k(d, "mouseout", this.rg, this)]);
                ...
                this.f.removeListener("zoom_changed", this.L,
                    this), this.f.removeListener("min_zoom_changed", this.L, this), this.f.removeListener("max_zoom_changed", this.L, this), this.f.removeListener("maptypeid_changed", this.L, this), this.f = a
    };
    c.fh = function (a) {
    ...
    c.L = function () {
        ...
        if (!this.Ie && this.Mc) {
            ...
            for (var n = b; n <= d; n++) {
                if (g = this.rf[n])
                    aa(g, 0, e), this.ad.appendChild(g);
                e += c
            }
            this.Mc = j
        }
        ...
        this.Lg = d;
        o(this.kf, {
            top: this.Jb * (a - this.Rb) +
            "px"
        });
        L(this.qg, 4, this.Jb * (a - this.Rb))
    };
    c.Of = function () {
        !this.ve && this.dd ? this.Zf = this.f.fc().clientHeight <= this.Ni : this.ve && (this.Zf = this.ve);
        var a = this.Zf;
        if (a !== this.Ie) {
            this.Ie = a;
            var b = this.vd,
            d = this.uf;
            a ? (Qa(b), za(d.a, -1, 0, 0), this.Te || (Qa(this.ad), m(this.qf, function (a) {
                        x(a)
                    }))) : (gb(b), za(d.a, 0), this.Te || (this.qf = [k(this.a, "mouseover", this.fh, this), k(this.a, "mouseout", this.rg, this)]), this.Mc = l, this.L())
        }
    };
    c.pg = function (a) {
        a = ra(a, this.vd);
    ...
    var nb = new Rd(6378137, 1 / 298.257223563, 5E5, 2E5, 1, 38, 127);
    Rd.prototype.inverse = function (a, b) {
        ...
        G =
            v / P;
        for (f = 1; 5 >= f; f++)
            h = r * G - p * d(2 * G) + s * d(4 * G) - t * d(6 * G) + u * d(8 * G), P = n * (1 - o) / e(g(1 - o * e(d(G), 2)), 3), G += (v - h) / P;
        ...
        P = p * (1385 + 3633 * e(p, 2) + 4095 * e(p, 4) + 1575 * e(p, 6)) /
            (40320 * P * e(r, 7) * e(i, 8));
        G = G - e(m, 2) * h + e(m, 4) * s - e(m, 6) * t + e(m, 8) * P;
        h = 1 / (r * o * i);
    ...
    c.W = function () {
        ...
        m = (d(e, 2) - d(k, 2)) / d(k, 2);
        k = (e - k) / (e + k);
        r = e * (1 - k + 5 * (d(k, 2) - d(k, 3)) / 4 + 81 * (d(k, 4) - d(k, 5)) / 64);
        ...
        s = o * v * d(l, 5) * f * (61 -
                58 * d(h, 2) + d(h, 4) + 270 * m - 330 * d(h, 2) * m + 445 * d(m, 2) + 324 * d(m, 3) - 680 * d(h, 2) * d(m, 2) + 88 * d(m, 4) - 600 * d(h, 2) * d(m, 3) - 192 * d(h, 2) * d(m, 4)) / 720;
    ...
    N.prototype.qh = function () {
        var a = nb.inverse(0.4 * this.e(), 0.4 * this.c());
    ...
    lc.prototype.sc = function () {
        for (var a = 4; 0 < a; ) {
            ...
            b.He.Tb && (this.Ic(b.He, b.url), b.He.Tb = j, --a)
        }
    };
    ...
    O(vb);
    Kb(vb);
    ya(vb, "min-width:0;min-height:0;max-width:none;max-height:none");
    var ab = {
        IDLE: 0,
        LOADING: 1,
        yf: 2,
    ...
    c.aa = function () {
        this.R = ab.LOADING;
        !db && qd && nd && (wc(this.a,
                0), mf(this.a, "opacity", 0.2));
        this.Cd = k(this.a, "load", this.w, this);
        Td(this, 1);
        this.hf(this.Sa.Ee(this.x, this.y, this.zoom))
    };
    c.hf = function (a) {
        this.a.src = a || mb + "nodata_2.png"
    };
    c.X = function () {
        ub.Wb.X.call(this);
        this.a && (x(this.Cd), Ea(this.a), this.Cd = this.Sa = this.a = f)
    };
    c.cancel = function () {
        x(this.Cd);
        this.a.src = Tb;
    ...
    mc.prototype.aa = function () {
        this.R = Te.LOADING;
        this.Qj = setTimeout(xa(this.w, this), 0)
    };
    mc.prototype.X = function () {
        Fa.prototype.X.call(this);
        this.a && (clearTimeout(this.Qj), Ea(this.a), this.Sa = this.a = f)
    };
    ...
    var Tc = new X(new N(-310763.0075, 1248227.06), new N(1616006.44, 2802998)),
    Ue = new X(new N(281515, 157035), new N(531417.5, -133097.5)),
    dd,
    yd = dd = new ea(256, 256, Ob(function (a, b, d) {
                return wa(a & 3) + "/map_2d/" + D.zf + "/L" + d + "/" + b + "/" + a + ".png"
            }), [new la("\uad6d\ud1a0\uc9c0\ub9ac\uc815\ubcf4\uc6d0, OpenStreetMap", "NGII, OSM", 3, Tc), new la("", "")], j, 1, 14),
    ed,
    zd = ed = new ea(256, 256, Ob(function (a, b, d) {
                return wa(a &
                    3) + "/map_skyview/L" + d + "/" + b + "/" + a + ".jpg" + D.Dh
            }), [new la("TerraMetrics", "TerraMetrics", 9), new la("\uc81c\uc8fc\ud2b9\ubcc4\uc790\uce58\ub3c4", "\uc81c\uc8fc\ud2b9\ubcc4\uc790\uce58\ub3c4", 0, Ue), new la("\uad6d\ud1a0\uc9c0\ub9ac\uc815\ubcf4\uc6d0", "NGII", 0)], l, 0, 14),
    fd,
    Ve = fd = new ea(256, 256, function (a, b, d) {
    ...
    vf = new ea(256, 256, function (a, b, d) {
        var c;
        c = d + 5;
        return !(-7488 >> c <= a && a <= 68E4 >> c && -102176 >> c <= b && b <= 635E3 >> c) ? "" : Ba + (Ia ? "ssl.daumcdn.net/" : "") + "r" + (a & 3) + ".maps.daum-img.net/mapserver/file/realtimeroad/L" + d + "/" + b + "/" + a + ".png?v=" + (+new Date / 6E4 | 0)
    }),
    ...
    if (Pb) {
        var Xd,
        yd = Xd = new ea(256, 256, Ob(function (a, b, d) {
                    return wa(a & 3) + "/map_2d_hd/" + D.zf + "/L" + d + "/" + b + "/" + a + ".png"
                }), [new la("\uad6d\ud1a0\uc9c0\ub9ac\uc815\ubcf4\uc6d0, OpenStreetMap",
                        "NGII, OSM", 3, Tc), new la("", "")], j, 1, 14),
        Yd,
        zd = Yd = new ea(256, 256, Ob(function (a, b, d) {
                    return wa(a & 3) + "/map_skyview_hd/L" + d + "/" + b + "/" + a + ".jpg" + D.Ch
    ...
    c.scale = function (a) {
        ...
        a.addListener("tick", this.$e, this);
        a.addListener("done", this.Ab, this)
    };
    c.$e = function (a) {
        var b =
        ...
        if (this.sf || !(0 == h && 0 == j)) {
            ...
            m(u, function (a) {
                var b =
                    a.x,
                d = a.y;
                k <= b && b < s && p <= d && d < r ? (t[(d - p) * o + b - k] = l, --v, u[A] = a, ++A) : zb || lb ? y.push(a) : x.push(a)
            }, this);
            if (0 < v) {
    ...
    xb.prototype.Uf = j;
    xb.prototype.oc = function (a) {
        this.Uf = a;
        Kc(this, j)
    };
    xb.prototype.Vf = f;
    q(yb, Qb);
    yb.prototype.oe = function (a) {
        m(a, function (a) {
            a.Tb || this.i.te(a)
        }, this);
        this.i.Ig()
    };
    yb.prototype.xc = function (a) {
        m(a, function (a) {
    ...
    yb.prototype.Pf = function () {
        for (var a; a = this.dg.pop(); )
            a.X()
    };
    q(Sb, Fa);
    Sb.prototype.te =
    ...
    Sb.prototype.Ig = function () {
        for (var a, b = S(64, this.i.length), b = y(b - this.Nc, 0), d = 0; d < b; d++)
            a = this.i.pop(), a.R === ab.IDLE && (this.Nc++, a.Tb = j, a.addListener("loaded", this.w, this), a.addListener("canceled", this.w, this), a.aa())
    };
    Sb.prototype.w = function (a) {
        a.removeListener("loaded", this.w, this);
        a.removeListener("canceled", this.w, this);
        this.Nc--;
        0 == this.Nc && (0 < this.i.length ? setTimeout(xa(this.Ig, this), 16) : 0 ===
            this.Nc && 0 == this.i.length && i(this, "tilesloaded"))
    };
    q($, Fa);
    $.prototype.f = f;
    $.prototype.C = function (a) {
        a != this.f && (this.f && this.f.Yg(this), (this.f = a) && a.Hf(this))
    };
    $.prototype.p = r("f");
    ...
    //var ie=new pc("http://http://172.23.187.59:8080//images/rhis/icon/marker.png",new Sa(29,42),new z(14,39),"poly","14,39,9,27,4,21,1,16,1,10,4,4,11,0,18,0,25,4,28,10,28,16,25,21,20,27");
    var ie = new pc("http://localhost:10001/images/icon/marker.png", new Sa(29, 42), new z(14, 39), "poly", "14,39,9,27,4,21,1,16,1,10,4,4,11,0,18,0,25,4,28,10,28,16,25,21,20,27");
    q(s, $);
    c = s.prototype;
    c.za = l;
    c.Za = j;
    ...
    c.M = function () {
        ...
        (a = this.fa) || (a = this.fa = p("img"), ya(a, "min-width:0;min-height:0;max-width:99999px;max-height:none;border:0;display:block"), O(a), Kb(a), this.a.appendChild(a));
        var b = this.T.jf,
        d = this.T.Hj;
        o(a, {
        ...
        Hb && /\.png$/i.test(b) && (d.onload = function () {
            this.onload = R;
            this.src = Tb
        }, d.style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' +
    ...
    c.kb = function () {
        ...
        this.Gb && (this.Qc(),
            ne(this), Ea(this.Ec), Ea(this.xd), this.xd = this.Dc = this.Ec = f)
    };
    c.aa = function () {
        Aa(this.a, this.$a);
        this.z()
    ...
    c.va = r("$a");
    c.Kc = function () {
        this.Ob || (i(this, "mouseover"), !this.H && !this.Na ? qa(this.fa, "inherit") : qa(this.fa, "pointer"))
    };
    c.Jc = function () {
    ...
    c.bh = function (a) {
        this.Fb = String(a);
        this.T.ae ? (this.fa && (this.fa.title = ""), this.Dc.title = this.Fb) : this.fa.title = this.Fb
    };
    c.yi = r("Fb");
    c.Ka = function () {
        var a = this.p().b,
    ...
    c.ii = function (a) {
        ...
        this.H ? (ba(a), this.yd ? (a = this.ua()) && this.s(a.me(new z(this.jh.e() - d, this.jh.c() - b))) : c && (this.yd = l, i(this, "dragstart"), rd(this.a), M && this.bb.stop())) : c && (this.yd = l)
    };
    c.ei = function (a) {
        i(this, "mouseup");
        if ("which" in a ? 3 == a.which : 2 == a.button || !a.preventDefault && 0 == a.button)
            this.Xd = l;
        this.yd ? this.H && i(this, "dragend") : this.Na && (this.p().We(),
            this.Ob && !this.Xd ? i(this, "click") : this.Ob && (zb || me) && this.Xd && i(this, "rightclick"));
        ne(this);
        qa(this.fa, "pointer")
    };
    c.ff = function (a) {
        Da(a) && (this.Qg = a, wc(this.fa, this.Qg))
    };
    c.kg = r("Qg");
    q(B, $);
    c = B.prototype;
    ...
    c.$d = function (a) {
        var b =
            this.bc;
        this.bc = a;
        "string" == typeof a ? this.a.innerHTML = a : a && (b && (this.a.innerHTML = ""), this.a.appendChild(a));
        oe(this)
    };
    c.Be = r("bc");
    c.za = l;
    ...
    c.Ka = function () {
        var a = this.za;
        if (this.p())
            var b = this.p().b, a = a && b.jd(this.Pc);
        var d = this.n;
        d instanceof Z && (d = d.N(), a = a && (!d || b.Fa(d)));
        a != this.Za && (b = this.a, (this.Za = a) ? (this.ud().Ue.appendChild(b), oe(this)) : Ea(b))
    };
    c.$a = 0;
    c.K = function (a) {
        this.$a = a;
    ...
    function (a) {
        if (a != this.f) {
            if (this.f) {
                var b = this.f;
                0 <= Pa(b.Lb, this) && (this.kb(), this.g = this.ea = f, this.Zd(f), ob(b.Lb, this))
            }
            if ((this.f = a) && 0 > Pa(a.Lb, this))
                a.Lb.push(this), this.ea = a.Ra, this.g = a.g, this.Zd(a.D), this.jb(), a.G || this.aa()
        }
    };
    c.Zd = $b("D");
    c.rj = function (a) {
    ...
    c.Re = function (a) {
        ...
        d = b.e() -
            this.Pa,
        c = b.c() - this.Qa;
        if (this.ga && (sa(d) > Ye || sa(c) > Ye))
            this.ga = j;
        this.ga || (this.Pa = b.e(), this.Qa = b.c(), i(this, "mousemove", this.Ea(a)))
    };
    c.Wj = function (a) {
    ...
    c.Cb = function (a) {
        ...
        b !== a.zIndex && a.zIndex !== C && this.K(a.zIndex)
    };
    c.jb = function () {
        this.od = l;
        this.pb();
        this.K(this.k.zIndex)
    };
    c.kb = function () {
        this.Rc()
    };
    ...
    c.pb = function () {
        ...
        if (a) {
            ...
            c = b.length,
            e = d.length;
            e > c && (c = d.splice(c, e - c), m(c, a.cc, a),
                c = this.Ga.splice(b.length), m(c, this.rj, this));
            m(b, function (b, c) {
                var e = d[c],
                F = !!e;
                F || (e = a.create("path"), e.zIndex = this.k.zIndex, d.push(e), this.Ga.push(jd(this, e)));
                a.qc(e, b);
                a.nb(e, this.od);
                F || a.tc(e)
            }, this)
    ...
    c.L = function () {
        if (this.Z) {
            ...
            if (a) {
                ...
                B = w.m(),
                C = w.h();
                if (this.oa < -ha(w) - 2 * B || this.pa < -ia(w) - 2 * C || this.ha > -ha(w) + 3 * B || this.qa > -ia(w) + 3 * C)
                    qe(this, j);
                else {
                    qe(this, l);
                    var D = [];
                    m(this.Vg, function (a) {
                        ...
                        m(a, function (a) {
                            ...
                            j ? (b || (c ? (b = [c.e() + F, c.c() + n], d = 2, t = S(t, c.e()), u = S(u, c.c()), v = y(v, c.e()), x = y(x, c.c())) : (b = [], d = 0), D.push(b)), t = S(t, i), u = S(u, h), v = y(v, i), x = y(x, h), b[d] = i, b[d | 1] = h, d += 2) : (b && (t = S(t, i), u = S(u, h), v = y(v, i), x = y(x, h), b[d] = i, b[d | 1] = h), b = f);
                            c = a
                        }, this)
                    }, this);
    ...
    c.ig = function () {
        ...
        m(this.Sd, function (b) {
            var d = b.length;
            if (0 < d)
                for (var c = K(b[this.ac ? d - 1 : 0]), e = this.ac ? 0 :
                        1; e < d; ++e) {
                    var g = K(b[e]),
                    f = g.e() - c.e(),
                    c = g.c() - c.c();
    ...
    c.Vb = function (a) {
        ...
        a.additionalStyles && (this.Eb =
                [b].concat(a.additionalStyles), this.Z = l)
    };
    q(da, fa);
    da.prototype.ac = l;
    ...
    c.z = function () {
        if (this.Z) {
            ...
            if (a) {
                ...
                b = b.x + c,
                a = a.x + c;
                this.D.yc(this.xb, [[b, e, b, d, a, d, a, e]], l)
            }
        }
    };
    c.va = function () {
    ...
    function (a) {
        var b = this.k.zIndex;
        this.D && (this.D.vc(this.qb, a, b), this.qb.zIndex = a);
        this.k.zIndex = a
    };
    q(J, V);
    c = J.prototype;
    ...
    c.M = function () {
        ...
        aa(b, 0, 0);
        a.appendChild(b);
        this.qj && (b = p("img"), b.alt = "close", b.width = 14, b.height = 13, b.src = vc + "bt_close.gif", O(b),
            o(b, {
                right: "5px",
                top: "5px"
    ...
    c.z = function () {
        ...
        if (a) {
            ...
            h = this.gb,
            h = h ? -h.T.td().c() : 0,
            c = this.If || n + 30 < i.y + h || i.y + n + 30 >= c.h() || b instanceof na;
            ...
            this.ag && this.If && (this.ag = j, b.Pd(Math.max(0, i.e() - e[0] - b.b.m() + 11) + Math.min(0, i.e() +
                        e[0] - 10), Math.min(0, i.c() + e[1] + h - 10)))
        }
    };
    c.Ka = function () {
        var a = this.p().b,
        ...
        c != this.Za && ((this.Za = c) ? (gb(this.a), ld(this)) : Qa(this.a))
    };
    c.bc = f;
    c.$d = function (a) {
        te(this, a);
    ...
    var ff =
        Bb + "m_bi_w.png",
//    Ce = Bb + "m_bi_b.png"; // 기존
        Ce = "/biz/si/main/getImgProxy.do?url=" + Bb + "m_bi_b.png"; // 프록시
    Ab.prototype.V = function (a) {
        this.Ub.V(a)
    };
    Ab.prototype.nb = function (a) {
        a = !!a;
        a != this.za && ((this.za = a) ? gb(this.a) : Qa(this.a))
    };
    Ab.prototype.s = function (a, b) {
        if (!(this.jc == a && this.Zg == b)) {
            this.jc = a || 0;
            this.Zg = b;
            var c = {},
            f = b ? "right" : "left";
            Da(a) ? (c[this.Fh[a]] = 0, c.bottom = 0) : c = a;
    ...
    c.ya = function (a) {
        ...
        c = this.ca.c(),
        f = A(2, -this.F);
        this.ka = new Ma(b + I((a.e() - b) * f - this.S / 2) / f, c + I((a.c() - c) * f - this.O / 2) / f)
    };
    c.I = function () {
    ...
    c.pi = function (a) {
        a = a.target;
        ve(this, (this.a == a || cc(this.a, a)) && 0 > Pa(["INPUT", "BUTTON", "TEXTAREA"],
                a.tagName))
    };
    c.Ji = function (a) {
        var b = a.keyCode;
        if (t.fb())
            t.Wa(a);
        else if (b in this.hh)
            this.Yc = l;
        else if (!this.Yc || this.hb.cb())
            b in this.Jd ? (this.ra |= this.Jd[b], this.Re(), ba(a)) : b in this.Ad ? (this.eb |= this.Ad[b], this.Me(), ba(a)) : b in this.yh && this.F(b)
    };
    c.Li = function (a) {
        var b = a.keyCode;
        this.Xf.start();
        if (t.fb())
            ...
            if (91 === b || 92 === b)
                ...
                b in this.Ad && (this.eb &= ~this.Ad[b])
    };
    c.Yh = function () {
        i(this, "keyup")
    };
    c.Ba = function () {
        var a = lf(Ne / 2 * (++this.Bg / this.Je)) / this.qi,
        b = {};
        0 >= a ? (this.hc.stop(), this.Bg = 0) : (b.x = this.Ke * a, b.y = this.Le * a, i(this, "move", b))
    };
    c.L = function () {
        ...
        if (a ||
            b)
            f = this.Hd < this.dc ? (kf(Ne * (++this.Hd / this.dc - 0.5)) + 1) / 2 : 1, f *= this.ih, c.x = a * f, c.y = b * f, i(this, "move", c)
    };
    c.Ti = function () {
        this.hb.start();
        this.Id.stop()
    ...
    c.Kc = function (a) {
        cc(this.t.a,
            a.relatedTarget || a.fromElement) || i(this, "mouseover")
    };
    c.Jc = function (a) {
        cc(this.t.a, a.relatedTarget || a.toElement) || i(this, "mouseout")
    };
    c.Wd = function (a) {
        t.fb(a) ? t.Wa(a) : (ba(a), i(this, "rightclick", this.Ea(a)))
    };
    c.H = j;
    c.Sc = j;
    c.wg = function () {
    ...
    c.Kj = function (a) {
        if (this.G || 1 < a.touches.length)
            this.md.stop(), this.zd = this.Fc = j;
            ...
            this.lh = a.e(), this.mh = a.c(), this.md.start(), this.zd = l
    };
    c.bi = function () {
    ...
    c.Tj = function (a) {
        t.fb(a) ? t.Wa(a) :
        1 == a.touches.length ? (this.bd = l, this.sg = this.Ea(a.touches[0]), this.bb.start(), De(this, a)) : this.bd && (ba(a), this.bd = j, this.ub(a.touches[0], l))
    };
    c.Ne = function (a) {
        t.fb(a) ? t.Wa(a) : (Gd(a) && De(this, a), this.G || i(this, "mousedown", this.Ea(a)))
    };
    c.Sj = function (a) {
        ba(a);
    ...
    c.th = function (a) {
        if (this.bd)
            return this.bd = j, this.ub(a.changedTouches[0], "touchcancel" == a.type)
    };
    c.tg = function (a) {
    ...
    c.Gd = function (a) {
        ...
        ta && (this.Mg = b.e(), this.Ng = b.c(), this.Ae && a.Uj && (c = Wb(a.Uj), F = Wb(a.Ik)));
        ...
        !this.ga && this.H && (this.Pa = b.e(), this.Qa = b.c(), a = c, this.b.moveBy(-a, F), this.t.Zb(a, F), this.ma.Zb(-a, -F), !Hb && !M && (this.u.rc(a, F), this.ia.rc(a, F)), i(this, "drag"), i(this, "center_changed"), i(this,
                "bounds_changed"))
    };
    c.Ea = function (a) {
        var a = ra(a, this.a),
    ...
    c.ub = function (a, b) {
        ...
        if (!b)
            if (this.ga)
                this.fd || (t.fb(a) ? t.Wa(a) : i(this, "click", this.Ea(a))), this.Sb = j, Oc(this), this.fd = j;
            else {
                var c = this.Vh,
                F = this.Wh;
    ...
    c.Qc = function () {
        ...
        x(this.sh);
        x(this.rh);
        this.rh = this.sh = this.uh = this.Pe = this.Oe = f
    };
    c.Wf = function (a) {
        if (!this.G)
            if (t.fb(a))
    ...
    c.Ta = function (a) {
        ...
        f = I(a.he - f);
        if (c || f)
            b.moveBy(-c, f), this.ma.Y(-a.ge, -a.he), !Hb && !M && (this.G || Vb(this))
    };
    c.Ve = function () {
        Vb(this);
        Ja(this);
    ...
    c.Yd = function (a, b, c, f, e) {
        f = v(f,
                300);
        0 === f ? (this.J.q(), this.Ab()) : (this.G = 0 !== f, this.ph = +new Date + 200, this.ia.P(), this.da.P(), a = A(2, -a), this.tf ? this.tf.reset(a, f) : (b = this.tf = new ec({
                    duration: f,
                    Yb: e,
                    vb: b,
                    wb: c,
                    yb: a
                }), zb || lb ? this.J.P() : this.J.scale(b), this.u.scale(b), b.start(), this.na.Da()))
    };
    c.Me = function (a, b, c, f, e, g, i, h, j) {
        0 === h ? (this.b.ya(this.Bb), this.t.Y(g, i), this.ma.Y(-g, -i), this.J.q(), this.Ab()) : (this.Cg = this.G = l, this.ia.P(), this.da.P(), a = A(2, -a), b = new Wc({
                duration: h,
                yb: a,
                Yb: j,
                vb: b,
            ...
            this.J.scale(b), c = this.t, b.addListener("tick", c.Ta, c), this.u.scale(b), b.start(), this.na.Da())
    };
    c.Ab = function () {
        Be(this);
        ...
        this.b.I().Fa(this.Fg) || i(this, "center_changed");
        i(this, "bounds_changed");
        Eb(this);
        this.Mb = 0;
        if (zb || lb) {
    ...
    c.gg = function (a) {
        if (!this.Ae && !this.G)
            if (t.fb(a))
                ...
                if (ta) {
                    this.Se.addPointer(a.pointerId);
                    b = ra(a, this.a);
                    if (2 > ++this.Oc) {
                        this.Mg = b.e();
                        this.Ng = b.c();
                ...
                Fd(this.J.a, b.e() - ha(this.b), b.c() - ia(this.b));
                this.na.P();
                this.ia.P();
                this.da.P();
                He(this);
                this.ye = ta ? k(this.t.a, "MSGestureChange", this.eg, this) : k(this.t.a, Na ? "touchmove" : "gesturechange", this.eg, this);
                this.fg = ta ? k(this.t.a, "MSGestureEnd", this.qd, this) : k(this.t.a, Na ? "touchend" : "gestureend", this.qd, this);
                ta && (this.xe = k(this.t.a, "MSPointerUp", this.qd, this));
                Na && (this.xe = k(this.t.a, "touchcancel", this.qd, this))
            }
    };
    c.eg = function (a) {
        ba(a);
    ...
    c.qd = function (a) {
        ...
        b = A(2, f) / b;
        f = bd(this.ze, this.b).e();
        c = bd(this.ze, this.b).c();
        this.G = l;
        b = new ec({
            duration: 100,
            vb: f,
    ...
    c.mi = function () {
        this.fd = l;
        this.Fc = j;
        i(this, "rightclick", this.sg)
    };
    c.ej = function () {
        var a = this.b.I().W(this.g);
    ...
    c.ya = function (a, b) {
        if (!this.G) {
            ...
            j;
            if (j = b.offset)
                g = this.b.j(), e = e.la(j.x / h || 0, -j.y / h || 0);
            if (!Sd(e, f, g)) {
                Db(this);
                c.ya(e);
                f = ha(c);
    ...
    c.mb = function (a, b) {
        if (!this.G) {
            ...
            if (0 != f) {
                ...
                i = b.anchor,
                h = b.animate;
                e = (h = h == l ? 3 > sa(f) : h || j) ? v(h.duration, 300) : 0;
                h = h && h.complete || R;
                i ? (this.Bb = i = va(K(i), this.g), c = new z(I((i.e() - c.ka.e()) * g), I((c.ka.c() - i.c()) * g) + c.h())) : (this.Bb = c.I(), c = new z(c.m() >> 1, c.h() >> 1));
                sc(this, f, c, {
                    duration: e,
                    complete: h
                })
    ...
    c.ie = function (a, b) {
        b = b === C ? Rc : b;
        if (a instanceof ib || a instanceof jc)
            a.C(this), a = a.a;
        this.wc.ie(a, b)
    };
    c.Vd = function (a) {
    ...
    c.Yg = function (a) {
        0 <= Pa(this.sa, a) && (a.kb(), a.ea = f, a.g = f, ob(this.sa, a))
    };
    c.Pd = function (a, b, c) {
        var c =
            c || {},
        ...
        Math.abs(a) < this.b.m() && Math.abs(b) < this.b.h() && 0 < c ? (Db(this), Fe(this, a, b, c, f)) : (a = Cb(this.b, new z((this.b.m() >> 1) + a, (this.b.h() >> 1) + b)).W(this.g), this.ya(a))
    };
    c.Tg = function (a, b) {
        if (a instanceof X)
            Ie(this, a, b);
    ...
    c.$g = function (a) {
        this.Qb ? this.Qb.setActive(a) : (this.Qb = new md(this.a,
                    a), this.Qb.addListener("move", this.Si, this), this.Qb.addListener("zoom", this.dk, this), this.Qb.addListener("keyup", this.tj, this))
    };
    c.wi = function () {
        return this.Qb.Gb
    };
    ...
    c.Hi = function (a, b, c) {
        ...
        if (!this.G) {
            a instanceof
            N || a instanceof pa ? (c.center = a, c.level = b) : c = a;
            var b = this.b,
            f = b.j();
            c.level = v(c.level, f);
            var a = K(c.center),
            ...
            i = A(2, -f);
            if (!Sd(a, h, f) || 0 !== c)
                this.Bb = a, f = new z(I((a.e() - b.ka.e()) * i), I((b.ka.c() - a.c()) * i) + b.h()), sc(this, c, f, {
                    duration: g,
                    Yb: e,
                    Jh: l
                }), b.ya(a)
    ...
    c.Yg = function (a) {
        0 <= Pa(this.sa, a) && (a.kb(), a.ea = f, a.g = f, a.Xg && a.Xg(), ob(this.sa, a))
    };
    c.Ja = function () {
        m(this.sa, gf)
    };
    ...
    c.xa = function (a, b) {
        ...
        if (h)
            ...
            O(c);
            db && !Oe ? (c.classid = "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000", c.codebase = "http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,124,0") : (c.type = "application/x-shockwave-flash", c.data = h);
            var g = e.m(),
            i = e.h();
            c.width = "100%";
            c.height = "100%";
            ...
            e = e.N();
            this.nf ? (g.storeId = this.nf, e && (g.storePanoId = e)) :
            (g.panoId = e, e = this.b.v(), g.panoX = e.e(), g.panoY = e.c());
            ...
            m([g, this.k], function (a) {
                for (var b in a)
                    a.hasOwnProperty(b) && "viewerUrl" != b && j.push(encodeURIComponent(b) + "=" + encodeURIComponent(a[b]))
            });
            var h = {
                movie: h,
                flashvars: j.join("&"),
            ...
            l;
            for (l in h)
                h.hasOwnProperty(l) && (e = p("param"),
                    e.name = l, e.value = h[l], c.appendChild(e));
            l = this.a;
            h = f;
    ...
    c.U = function (a, b) {
        ...
        this.b.U(a);
        this.xa("moveRoadByPanoId", a, c, f)
    };
    c.Ta = 0;
    c.$c = 0;
    c.F = 0;
    ...
    c.Xc = function (a) {
        ...
        this.b.V(b);
        a.panoId ? this.xa("moveRoad", a.panoId, this.Ta, this.$c, a.zoom) : this.xa("setPanTiltZoom", this.Ta, this.$c, b)
    };
    c.Bc = function () {
    ...
    c.s = function (a) {
        this.b.v().Fa(a) || (this.b.s(a), this.w && (i(this, "position_changed"), i(this,
                    "panoid_changed")))
    };
    c.v = function () {
        return ua(this.b.v())
    ...
    c.df = function () {
        this.l &&
        this.b.U(Number(this.l.getPanoId() || 0))
    };
    c.ef = Oa();
    c.jc = cb;
    c.s = function (a) {
    ...
    c.Xc = function (a, b) {
        if (this.i)
            ...
            this.b.V(a.zoom);
            a.panoId && c.setPanoId(a.panoId);
            c.setViewpoint(a.pan, a.tilt, a.zoom,
                b)
        }
    };
    c.N = function () {
    ...
    Gb.SCRIPT_URL = Ba + Xb.Bf.replace(/^\/\//g, "");
    var Me = f;
    ...
    c.Zi = function (a) {
        this.l.Pb() && (this.l.Ta = a.pan,
            this.l.$c = a.tilt, i(this.l, "viewpoint_changed", C))
    };
    c.Pg = function (a) {
    ...
    Pc.prototype.xi = function (a, b, c) {
        ...
        Q[h] = function (a) {
            ...
            Number(a.street_view[0].cnt) ? (b.service = l, a = a.street_view[1].street[0], b.id = a.id, b.photox = a.photox, b.photoy = a.photoy, b.addr = a.addr, b.st_name = a.st_name, b.st_type = a.st_type, b.date = a.date, c(b.id, b)) : c(f)
        };
        Dd[h] = a;
        b = Ua();
    ...
    c.Va = function () {
        var a = this.Dd,
        b = [];
        b.push("IW=" + String(this.b.m() | 0) + "&IH=" +
            String(this.b.h() | 0));
        b.push(jf(this));
        ...
        if (!this.Bi || this.Hg) {
            a = this.Dd;
            if (!(b = this.Hg)) {
                b = '"mapCenterX":' + uc(this).e() + ',"mapCenterY":' + uc(this).c() + ',"mapLevel":' + this.b.j() + ',"coordinate":"wcongnamul"';
                c = "TYPE_MAP";
                e = "false";
    ...
    ga.prototype.isEmpty = ga.prototype.zg;
    ...
    h.prototype.getCenter = h.prototype.I;
    ...
    h.prototype.addControl = h.prototype.ie;
    h.prototype.removeControl = h.prototype.Vd;
    h.prototype.addOverlayMapTypeId = h.prototype.ke;
    h.prototype.removeOverlayMapTypeId =
        h.prototype.Ze;
    h.prototype.getDraggable = h.prototype.Ce;
    ...
    h.prototype.getProjection = h.prototype.ua;
    ...
    u.MapTypeId = ka;
    Ha.prototype.pointFromCoords =
        Ha.prototype.lb;
    Ha.prototype.coordsFromPoint = Ha.prototype.Tf;
    Ha.prototype.containerPointFromCoords = Ha.prototype.ab;
    Ha.prototype.coordsFromContainerPoint = Ha.prototype.me;
    Ya.prototype.viewpointFromCoords = Ya.prototype.Zj;
    u.ControlPosition = fb;
    fb.TOPLEFT = xc;
    fb.TOP = td;
    fb.TOPRIGHT = yc;
    fb.BOTTOMLEFT = vd;
    ...
    s.prototype.getVisible = s.prototype.Fe;
    s.prototype.setZIndex = s.prototype.K;
    ...
    s.prototype.getDraggable = s.prototype.Ce;
    s.prototype.setAltitude = s.prototype.nc;
    s.prototype.getAltitude = s.prototype.ec;
    ...
    w.prototype.setContent = w.prototype.$d;
    w.prototype.getContent = w.prototype.Be;
    w.prototype.setZIndex = w.prototype.K;
    ...
    B.prototype.setContent = B.prototype.$d;
    B.prototype.getContent = B.prototype.Be;
    B.prototype.setVisible = B.prototype.nb;
    B.prototype.getVisible = B.prototype.Fe;
    B.prototype.setZIndex = B.prototype.K;
    ...
    fa.prototype.setZIndex = fa.prototype.K;
    ...
    da.prototype.getLength =
        da.prototype.ig;
    da.prototype.getArea = da.prototype.ti;
    da.prototype.setZIndex = da.prototype.K;
    ...
    J.prototype.getRadius = J.prototype.De;
    ...
    J.prototype.setZIndex = J.prototype.K;
    ...
    T.prototype.getPosition = T.prototype.v;
    ...
    ja.prototype.onChangedDirection =
        ja.prototype.Zi;
    ...
    u.RoadviewOverlay = kb;
    kb.prototype.setMap = kb.prototype.C;
    kb.prototype.getMap = kb.prototype.p;
    u.StaticMap = oa;
    ...
    oa.prototype.getCenter = oa.prototype.I;
    oa.prototype.setCenter = oa.prototype.ya;
    u.Tileset = ea;
    ea.add = wb;
    u.disableBusSymbol = function () {
        dd.Ee = Ob(function (a, b, c) {
            return wa(a & 3) + "/map_office/2d/L" + c + "/" + b + "/" + a + ".png"
        });
        fd.Ee = Ob(function (a, b, c) {
            return wa(a & 3) + "/map_office/hybrid/L" + c + "/" + b + "/" + a + ".png"
        });
        Pb && Wd()
    };
    u.disableHD = Wd;
