...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBusinessException(BusinessException e) {
        ...
        ResponseEntity<ApiResponse<Void>> response = ApiResponse.<Void>error(ApiResultCode.UNKNOWN_ERR, e.getMessage());
        return response;
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> handleValidationExceptions(
        ...
        ResponseEntity<ApiResponse<Map<String, String>>> response = ApiResponse.<Map<String, String>>error(
    ...
    public ResponseEntity<ApiResponse<Void>> handleIllegalArgumentException(
        ...
        ResponseEntity<ApiResponse<Void>> response = ApiResponse.<Void>error(
                ApiResultCode.PARAM_VALID_ERR, 
